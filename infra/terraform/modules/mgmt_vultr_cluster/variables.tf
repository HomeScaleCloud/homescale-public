...
variable "k8s_version" {
  description = "Kubernetes version string as returned by the Vultr API (e.g. v1.32.3+1). Check available versions at https://api.vultr.com/v2/kubernetes/versions"
  type        = string
}
