locals {
  apps_all = [
    ...
    },
    {
      ...
      values = {
        ingress = {
          host = "ha.${var.cluster}.${var.region}.REDACTED"
        }
      }
    ...
    },
    {
      ...
      values = {
        ingress = {
          host = "librespeed.${var.cluster}.${var.region}.REDACTED"
        }
      }
    ...
    },
    {
      ...
      values = {
        ...
        oneuptimeIngress = {
          ...
          tls = {
            enabled = true
            hosts   = [{ host = "metrics.${var.cluster}.${var.region}.REDACTED", secretName = "oneuptime-tls" }] # pragma: allowlist secret
          }
        }
      }
