    ...
    // This tailnet's ACLs are maintained in https://github.com/HomeScaleCloud/homescale
    {
      "acls": [
        ...
        },
        {
          "action": "accept",
          "src": [
            "group:Kubernetes Viewers@REDACTED",
            "group:Kubernetes Admins@REDACTED"
          ],
          "dst": ["tag:k8s-api:443"]
        },
        {
      ...
      "grants": [
        {
          "src": ["group:Kubernetes Viewers@REDACTED"],
          "dst": ["tag:k8s-api"],
          "app": {
        ...
        {
          "src": ["group:Kubernetes Admins@REDACTED"],
          "dst": ["tag:k8s-api"],
          "app": {
            "tailscale.com/cap/kubernetes": [
              {
