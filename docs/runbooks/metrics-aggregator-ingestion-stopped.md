...
| NetBird mesh or DNS issue for `REDACTED` | Check the `netbird-crs` `NetworkResource` for the aggregator's `prometheus` Service and NetBird connectivity from other clusters |
