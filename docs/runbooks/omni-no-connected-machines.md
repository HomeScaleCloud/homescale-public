...
dig REDACTED
nc -zu REDACTED 50180   # UDP — no output on success is normal
...
| `REDACTED` DNS change | `dig` returns a different address than expected | Revert DNS change in Terraform |
